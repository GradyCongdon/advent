...
guards = guards.filter(g => g).sort((a, b) => b.times.length - a.times.length);
const sleepiest = guards[0];

let mostMinute = 0;
const minuteCounts = sleepiest.minutes.reduce((counts, minute) => {
...
mostMinute = Object.keys(minuteCounts).reduce((max, key) => {
...
console.log(sleepiest.id * mostMinute);
